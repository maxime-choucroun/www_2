...
function Load_Sentences(ArrayObj) { 
      ...
      ArrayObj.push({  sId:'DisplayPerson_Existed', sName:'DisplayPerson_Existed', sAttributeName: 'value', 
                       ...
                       sRu:  '(деактивированный аккаунт) (Ru)',
